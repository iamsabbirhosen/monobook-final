...
import { book1Explanations } from '@/lib/explanations';
...
export default function ReaderClient({ book }: { book: Book }) {
  ...
  const handleAiHelp = async () => {
    ...
    setTimeout(() => {
      let explanation = "Sorry, I don't have an explanation for this page yet.";
      
      // Check if we have an explanation for the current page of book 1
      if (book.id === '1' && book1Explanations[pageNumber]) {
        explanation = book1Explanations[pageNumber];
      }
